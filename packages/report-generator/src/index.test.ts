  ...
  return {
    ...
    vulnerabilities: [
      ...
      },
      {
        ...
        fileName: "TokenVault.sol",
        functionName: "mint",
        vulnerableCode: "function mint(address to, uint256 amount) external { ... }",
        fixedCode: "function mint(address to, uint256 amount) external onlyOwner { ... }",
        references: [],
        cvssScore: null,
    ...
    recommendations: [
      ...
      },
      {
        ...
        codeSnippet: "onlyOwner",
        fixedCodeSnippet: "function mint(address to, uint256 amount) external onlyOwner { ... }",
        references: [],
      },
    ],
    gasAnalysis: {
